  ...
  const appGuides = [
    ...
    },
    {
      ...
      tips: [
        ...
        '불규칙한 수업이나 이번 주만 변경된 일정은 시간표 빈 칸이나 카드를 눌러 손쉽게 수정/이동할 수 있습니다.',
    ...
    },
    {
      ...
      icon: 'users',
      title: '4. 학생 관리 & 이력 조회',
      desc: '수강생들의 기본 정보(연락처, 수강 과정, 정규 수업 시간 등)를 관리하고, 학생별 전체 수업 일지 기록과 통계를 한곳에서 확인합니다.',
      tips: [
            ...
            <View style={styles.profileCard}>
              ...
              <View style={styles.badgeContainer}>
                <View style={styles.badge}>
                  <Text style={styles.badgeText}>mydiary v2.1.0</Text>
                </View>
              </View>
            </View>
