...
export default function HelpScreen() {
  ...
  const appGuides = [
    {
      ...
      tips: [
        ...
        '빠른 메뉴를 통해 주간 시간표, 학생 등록 및 구글 드라이브 백업 설정으로 즉시 이동 가능합니다.'
      ]
    },
    {
      id: 'weekly',
      icon: 'calendar',
      title: '2. 주간 시간표 & 업무 보고서 (한글 .hwpx / 워드 .docx / PDF)',
      desc: '1주일간의 방문 수업 계획을 타임테이블 표로 작성하고, 표준 한글 문서(.hwpx), 구글 문서 / MS 워드(.docx) 및 정규 A4 주간 업무 보고서 PDF로 자유롭게 내보내고 공유합니다.',
      tips: [
        '시간표에는 현재 활동 중인 "재원생"의 수업만 표기되어 스케줄 관리가 더욱 명확해집니다.',
        '주간 전체 표에서 원하는 요일과 시간대 칸(빈 칸의 "+" 또는 수업 카드)을 터치하면 그날의 수업 예정 시간표를 즉시 작성하거나 편집할 수 있습니다.',
        '학생 등록 시 "정규 수업 일정"을 지정해 두면 매주 주간 시간표가 자동 완성됩니다.',
        '상단 [보고서 내보내기] 버튼을 통해 A4 PDF 무선 인쇄는 물론, 한글 표준 문서(.hwpx) 및 구글 문서 / MS 워드(.docx) 파일로 공유하여 PC나 스마트폰에서 자유롭게 수정·편집할 수 있습니다.',
        '시간표 카드의 [일지 작성]을 누르면 당일 수업 기록으로 자동 연결됩니다.'
      ]
    },
    {
      id: 'calendar',
      ...
      tips: [
        ...
        '상단 우측 [주간시간표] 버튼으로 주간 계획 화면으로 바로 전환할 수 있습니다.'
      ]
    },
    {
      id: 'students',
      icon: 'users',
      title: '4. 학생 관리 & 수강 차수 이력',
      desc: '수강생들의 기본 정보(연락처, 수강 과정, 정규 수업 시간 등)를 관리하고, 재원생/휴회생 구분 및 수강 차수(Terms) 이력을 체계적으로 관리합니다.',
      tips: [
        '상단 [재원생] / [휴회생] / [전체] 필터 탭으로 수강생을 한눈에 구분하여 조회할 수 있습니다.',
        '학생 카드 메뉴에서 [휴회 처리]를 통해 일시 정지하거나, [재수강 시작]으로 새로운 수강 차수(2차, 3차...)를 시작할 수 있습니다.',
        '학생 상세 화면에서 "정규 수업 일정 (요일 및 시간)"을 등록해 두면 주간 시간표에 매주 자동 배치됩니다.',
        '학생 카드 출력 시 학생의 전체 수강 차수 및 기간 이력이 A4 보고서에 정갈하게 인쇄됩니다.'
      ]
    },
    {
      id: 'print',
      icon: 'printer',
      title: '5. 주간 보고서 / 학생 카드 / 일지 출력 및 공유\n    (한글 hwpx / 워드 docx / PDF / 무선 인쇄)',
      desc: '주간 업무 보고서, 학생 인적사항 카드 및 수업 일지를 A4 양식으로 무선 프린터 인쇄하거나, 한글 문서(.hwpx), 구글 문서(.docx), 고화질 PDF로 카카오톡/메시지 발송할 수 있습니다.',
      tips: [
        '1) 주간시간표 탭: 상단 [보고서 내보내기] 버튼으로 한글 문서(.hwpx), 구글 문서 / MS 워드(.docx), A4 PDF 무선 인쇄 및 고화질 PDF 공유를 원클릭으로 실행합니다.',
    ...
    },
    {
      ...
      icon: 'settings',
      title: '6. 데이터 백업 & 복원',
      desc: '소중한 수업, 학생, 주간 계획 데이터를 개인 구글 드라이브에 안전하게 보관하여 기기 변경이나 분실 시에도 완벽하게 복원할 수 있습니다.',
      tips: [
  ...
  const faqs = [
    {
      q: '주간 업무 보고서(한글 hwpx / 워드 docx / PDF)는 어떻게 생성하나요?',
      a: '하단 탭의 [주간시간표] 메뉴로 이동하신 후, 상단 우측의 [보고서 내보내기] 버튼을 누르시면 이번 주차의 A4 주간 업무 보고서를 한글 문서(.hwpx), 구글 문서 / 워드(.docx), 고화질 PDF 공유 또는 Wi-Fi 무선 프린터 인쇄로 즉시 내보낼 수 있습니다.'
    },
    {
      q: '주간 업무 보고서를 한글 문서(.hwpx)나 구글 문서 / 워드(.docx)로 편집할 수 있나요?',
      a: '네, 완벽하게 지원합니다! [주간시간표] 상단의 [보고서 내보내기] 버튼을 누른 후 "한글 문서 (.hwpx) 파일 공유" 또는 "구글 문서 / 워드 (.docx) 파일 공유"를 선택하시면 표준 서식 파일이 생성됩니다. 이를 카카오톡, 이메일, 클라우드로 전송하여 PC나 스마트폰의 한글(한컴오피스), MS Word, 구글 문서에서 자유롭게 수정하고 재가공하실 수 있습니다.'
    },
    {
      q: '주간 전체 표에서 직접 수업 일정을 등록할 수 있나요?',
      a: '네! [주간 전체 표]에서 원하는 요일과 시간대 칸(빈 칸의 "+" 아이콘 또는 기존 수업 카드)을 터치하시면 해당 시간대의 수업 일정 추가/편집 팝업이 바로 열려 즉시 등록 및 수정이 가능합니다.'
    },
    {
      q: '어떤 학생이 이번 주만 시간을 바꿨을 때는 어떻게 하나요?',
      a: '주간시간표 화면에서 해당 학생의 수업 카드를 터치하신 후, [요일]이나 [시작 시간]을 변경하시고 특이사항 메모에 "=> 이번주만", "=> 보강" 등을 선택/입력하여 저장하시면 이번 주 시간표와 보고서에만 즉시 반영됩니다.'
    },
    {
    ...
    },
    {
      ...
      a: '네, 가능합니다! mydiary는 모든 데이터가 기기 내부 로컬 저장소에 안전하게 보관되므로 오프라인 상태에서도 수업 계획 및 일지 작성, 학생 관리가 자유롭습니다. 단, 구글 드라이브 백업/복원 시에만 인터넷 연결이 필요합니다.'
    },
    {
            ...
            <View style={styles.profileCard}>
              ...
              <View style={styles.badgeContainer}>
                <View style={styles.badge}>
                  <Text style={styles.badgeText}>mydiary v{packageJson.version}</Text>
                </View>
              </View>
            </View>
