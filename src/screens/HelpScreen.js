...
export default function HelpScreen() {
  ...
  const appGuides = [
    ...
    },
    {
      id: 'weekly',
      icon: 'calendar',
      title: '2. 주간 시간표 & 업무 보고서 (신규 v2.0)',
      desc: '1주일간의 방문 수업 계획을 타임테이블 표로 작성하고, A4 주간 업무 보고서 PDF를 원클릭으로 인쇄 및 공유합니다.',
      tips: [
        '학생 등록 시 "정규 수업 일정"을 지정해 두면 매주 주간 시간표가 자동 완성됩니다.',
        '불규칙한 수업이나 이번 주만 변경된 일정은 시간표 빈 칸이나 카드를 눌러 손쉽게 수정/이동할 수 있습니다.',
        '상단 [보고서 PDF] 버튼을 눌러 A4 주간 업무 보고서(월~토 타임테이블 + 일요일 시간표 + 전화관리 + 주요사항)를 출력합니다.',
    ...
    },
    {
      id: 'print',
      icon: 'printer',
      title: '5. 학생 카드 / 일지 / 주간 보고서 출력\n    (무선 인쇄 / 카톡 공유)',
      desc: '주간 업무 보고서, 학생 인적사항 카드 및 수업 일지를 A4 양식으로 무선 프린터 인쇄하거나, 고화질 PDF로 카카오톡/메시지 발송할 수 있습니다.',
      tips: [
        '1) 주간시간표 탭: 상단 [보고서 PDF] 버튼으로 주간 업무 보고서를 1초 만에 인쇄 및 공유합니다.',
  ...
  const faqs = [
    {
      q: '주간 업무 보고서(PDF)는 어떻게 생성하나요?',
      a: '하단 탭의 [주간시간표] 메뉴로 이동하신 후, 상단 우측의 [보고서 PDF] 버튼을 누르시면 이번 주차의 A4 주간 업무 보고서가 자동 생성되어 무선 프린터 인쇄 및 카톡/메일 PDF 파일 공유가 가능합니다.'
    },
    {
            ...
            <View style={styles.profileCard}>
              ...
              <View style={styles.badgeContainer}>
                <View style={styles.badge}>
                  <Text style={styles.badgeText}>mydiary v2.0.0</Text>
                </View>
              </View>
            </View>
