# MyDiary (내 일상 수업 다이어리) - v2.1.0

**MyDiary**는 방문 강사 및 교사를 위해 제작된 통합 수업 관리 모바일 애플리케이션입니다.  
단순한 사후 기록을 넘어 **"주간 수업 계획(스케줄링) ➔ 방문 수업 이동 ➔ 수업 일지 기록 ➔ 주간 업무 보고서(PDF / 구글 문서 .docx) 자동 출력"**에 이르는 전 과정을 하나로 완벽하게 일원화한 올인원 솔루션입니다.
...
*   **주간 업무 보고서 구글 문서(.docx) & PDF 원클릭 출력 (신규 v2.1.0)**:
